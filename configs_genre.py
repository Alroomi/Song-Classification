...
def gen_config(task, model):
    ...
    cfgs['task'] = task
    cfgs['data_dir'] = './data/6th Nov/genre/songs'
    ...
    cfgs['list_fname'] = os.path.join(cfgs['data_dir'], 'temp_genre.txt')
    ...
    cfgs['feature_pool'] = 'mean' # 'none' # 'mean' # 'sum', 'flatten', 'max'
    cfgs['l2_norm'] = False
    ...
    # testing configs
    nn_cfgs['ensemble_mode'] = 'score_sum' #'voting' # 'voting' or 'score_sum'
    return cfgs, nn_cfgs
